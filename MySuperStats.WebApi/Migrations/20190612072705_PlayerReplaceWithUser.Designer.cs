...
namespace MySuperStats.WebApi.Migrations
{
    ...
    [Migration("20190612072705_PlayerReplaceWithUser")]
    partial class PlayerReplaceWithUser
    {
            ...
            modelBuilder.Entity("MySuperStats.WebApi.Models.MatchGroupUser", b =>
                {
                    ...
                    b.HasIndex("PlayerId")
                        .HasName("ix_match_group_users_player_id");
            ...
            modelBuilder.Entity("MySuperStats.WebApi.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "a6ab7372-f48b-433e-95a6-34383e7e0309",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "634c9ce9-9bac-4f90-891e-37ca84ffeb6f",
                            Name = "Player",
            ...
            modelBuilder.Entity("MySuperStats.WebApi.Models.MatchGroupUser", b =>
                {
                    ...
                    b.HasOne("MySuperStats.WebApi.Models.Player", "Player")
                        .WithMany("MatchGroupUsers")
                        .HasForeignKey("PlayerId")
                        .HasConstraintName("fk_match_group_users_players_player_id")
                        .OnDelete(DeleteBehavior.Restrict);
