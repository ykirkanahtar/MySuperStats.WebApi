...
{
    public class ClaimManager : BusinessManagerBase<ClaimManager, ApiRequest>, IClaimManager
    {
        public ClaimManager(IUnitOfWork unitOfWork, ILogger<ClaimManager> logger, IMapper mapper, IApiRequestAccessor apiRequestAccessor) : base(unitOfWork, logger, mapper, apiRequestAccessor)
        {
